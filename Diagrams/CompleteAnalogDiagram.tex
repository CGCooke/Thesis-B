...
\begin{tikzpicture}[auto, node distance=2cm,>=latex']
    ...
    %Common
    \draw [->] (rinput) -- node{I \& Q} (Rotator);
    
    %FLL Stuff
    \draw [-] (Rotator) -- node{} (RotatorPickoffPoint);
    ...
    \draw [->] (VCO) -- node{} (Rotator);
    
    

    \end{tikzpicture}
\caption{An analog model of the FLL and PLL tracking loops.} \label{fig:CompleteAnalogDiagram}
\end{figure}
