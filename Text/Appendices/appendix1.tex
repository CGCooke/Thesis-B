...
\begin{figure}[!htb] 
    \centering
    \includegraphics[width=1\textwidth]{SoyuzAcceleration.png} 
...
\begin{figure}[!htb] 
    \centering
    \includegraphics[width=1\textwidth]{SoyuzRelativeVelocity.png} 
...
\begin{figure}[!htb] 
    \centering
    \includegraphics[width=1\textwidth]{MinotaurMissionProfile.png} 
...
\begin{figure}[!htb] 
    \centering
    \includegraphics[width=1\textwidth]{Falcon9Profile.png} 
